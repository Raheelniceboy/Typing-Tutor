...
<body>
  ...
  FB.getLoginStatus(function(response) {
    ...
    if (response.status === 'connected') {
    	FB.api('me', function(response){
    		// console.log("This is some of your information:");
  ...
  function testAPI() {
    ...
    FB.api('/me?fields=email,first_name,name', function(response) {
      ...
      // console.log('Your first name: ' + response.first_name);
      // $('#profilePicture').replaceWith('<div><img src=http://graph.facebook.com/' + response.id + '/picture></div>');
