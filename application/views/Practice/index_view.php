  ...
  <main class="container">
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>
          <a class="btn btn-success" href="<?php echo base_url("practice/paragraph/100"); ?>">100 words</a> 
          <a class="btn btn-warning" href="<?php echo base_url("practice/paragraph/150"); ?>">150 words</a> 
          <a class="btn btn-danger" href="<?php echo base_url("practice/paragraph/200"); ?>">200 words</a>
        </p>
      </div>
    </div>
